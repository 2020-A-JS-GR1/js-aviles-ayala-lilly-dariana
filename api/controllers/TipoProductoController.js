...
module.exports = {
  'Registrar':function(req,res){
      ...
      TipoProducto.create({
       ...
       descripcion:datos.descripcion
        ...
        () =>{
            return res.status(200).json({mensaje:`El tipo de producto se registró exitosamente`});
          }
      ).catch(
        () =>{
  ...
  'Actualizar':function(req,res){
      ...
      TipoProducto.update({
        ...
        () =>{
            return res.status(200).json({mensaje:`El tipo de producto se actualizó exitosamente`});
          }
      ).catch(
        () =>{
            return res.status(400).json({mensaje:`Ocurrió un error`});
